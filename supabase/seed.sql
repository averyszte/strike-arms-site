...
--
-- WARNING: DEV/DEMO DATA ONLY — WRONG BRANDS. Written before we learned the shop's
-- real range is ASG, CYMA and EVOLUTION (Italian; not E&L). Strike Arms does
-- NOT sell G&G, Specna Arms, Tokyo Marui, Krytac or most brands seeded below.
-- Do not seed a production database with this file; replace with the real
-- catalogue once Alan confirms model lines. See seo/changelist.md.
--
